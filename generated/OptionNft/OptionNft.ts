...
export class OptionNft extends ethereum.SmartContract {
  static bind(address: Address): OptionNft {
    return new OptionNft("OptionNft", address);
  }
  ...
  batchMint(
    ...
    let result = super.call(
      "batchMint",
      "batchMint(address[],uint256[],string[]):(bool)",
      [
  ...
  mint(to: Address, tokenId: BigInt, tokenURI: string): boolean {
    let result = super.call("mint", "mint(address,uint256,string):(bool)", [
  ...
  try_mint(
    ...
    let result = super.tryCall("mint", "mint(address,uint256,string):(bool)", [
      ethereum.Value.fromAddress(to),
      ethereum.Value.fromUnsignedBigInt(tokenId),
      ethereum.Value.fromString(tokenURI)
    ]);
