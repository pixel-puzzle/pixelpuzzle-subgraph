...
export class UnsetPauseCall extends ethereum.Call {
  get inputs(): UnsetPauseCall__Inputs {
    return new UnsetPauseCall__Inputs(this);
  }

  get outputs(): UnsetPauseCall__Outputs {
    return new UnsetPauseCall__Outputs(this);
  }
}

export class UnsetPauseCall__Inputs {
  _call: UnsetPauseCall;

  constructor(call: UnsetPauseCall) {
    this._call = call;
  }
}

export class UnsetPauseCall__Outputs {
  _call: UnsetPauseCall;
